...
class CropCachedDataPaird(Randomizable):
    ...
    def __init__(self, patch_size_lr, up_factor, crop_type, load_LR=True, pad_size=0):
...
class CropCachedDataPairImplicitd(Randomizable):
    ...
    def __init__(self, patch_size_lr, up_factor, crop_type, load_LR=True, mode="train"):
        self.size_lr = patch_size_lr
        self.crop_type = crop_type
        self.load_LR = load_LR
        self.up_factor = up_factor
