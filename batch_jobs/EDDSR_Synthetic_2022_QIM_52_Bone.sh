...
#BSUB -q gpua100
#BSUB -J August_XtremeCT_single_EDDSR
...
python -u train.py --options_file train_EDDSR_Synthetic_2022_QIM_52_Bone.json

python -u test_simple.py --options_file train_EDDSR_Synthetic_2022_QIM_52_Bone.json
