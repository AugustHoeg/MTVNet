...
#BSUB -q gpua100
#BSUB -J August_XtremeCT_single_MFER
...
python -u train.py --options_file train_MFER_BRATS2023.json

python -u test_simple.py --options_file train_MFER_BRATS2023.json
