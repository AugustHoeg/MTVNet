...
#BSUB -q gpua100
#BSUB -J August_XtremeCT_single_mDCSRN_4x
...
python -u train.py --options_file train_mDCSRN_Synthetic_2022_QIM_52_Bone_4x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_mDCSRN_Synthetic_2022_QIM_52_Bone_4x.json --cluster "DTU_HPC"
