...
#BSUB -q p1
#BSUB -J August_XtremeCT_single_EDDSR_3x
...
python -u train.py --options_file train_EDDSR_Synthetic_2022_QIM_52_Bone_3x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_EDDSR_Synthetic_2022_QIM_52_Bone_3x.json --cluster "DTU_HPC"
