...
#BSUB -q p1
#BSUB -J August_XtremeCT_single_RRDBNet3D_1x
...
python -u train.py --options_file train_RRDBNet3D_2022_QIM_52_Bone_1x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_RRDBNet3D_2022_QIM_52_Bone_1x.json --cluster "DTU_HPC"
