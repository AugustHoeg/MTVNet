...
#BSUB -q p1
#BSUB -J August_XtremeCT_single_SuperFormer
...
python -u train.py --options_file train_SuperFormer_Synthetic_2022_QIM_52_Bone_4x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_SuperFormer_Synthetic_2022_QIM_52_Bone_4x.json --cluster "DTU_HPC"
