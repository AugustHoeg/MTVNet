...
#BSUB -q p1
#BSUB -J August_XtremeCT_retest_1
...
python -u test_simpleV3.py --experiment_id "AugustNet_ps32_3x_ID007598_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "EDDSR_ps32_4x_ID002601_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "SuperFormer_ps32_4x_ID006535_L1_100K" --cluster "DTU_HPC"
