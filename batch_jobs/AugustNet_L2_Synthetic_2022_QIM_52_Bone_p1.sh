...
/
#BSUB -q p1
#BSUB -J August_XtremeCT_single_AugustNet_L2_p1
...
python -u train.py --options_file train_AugustNet_L2_Synthetic_2022_QIM_52_Bone.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_AugustNet_L2_Synthetic_2022_QIM_52_Bone.json --cluster "DTU_HPC"
