...
python -u train.py --options_file train_AugustNet_KIRBY21.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_AugustNet_KIRBY21.json --cluster "DTU_HPC"
