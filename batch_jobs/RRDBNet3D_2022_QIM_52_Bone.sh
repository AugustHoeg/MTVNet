...
python -u train.py --options_file train_RRDBNet3D_2022_QIM_52_Bone.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_RRDBNet3D_2022_QIM_52_Bone.json --cluster "DTU_HPC"
