...
python -u train.py --options_file train_RRDBNet3D_BRATS2023_4x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_RRDBNet3D_BRATS2023_4x.json --cluster "DTU_HPC"
