...
#BSUB -q p1
#BSUB -J August_XtremeCT_single_AugustNet
...
python -u train.py --options_file train_AugustNet_L1_BRATS2023_4x_no_shift.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_AugustNet_L1_BRATS2023_4x_no_shift.json --cluster "DTU_HPC"
