...
python -u train.py --options_file train_SuperFormer_2022_QIM_52_Bone_3x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_SuperFormer_2022_QIM_52_Bone_3x.json --cluster "DTU_HPC"
