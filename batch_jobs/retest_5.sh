...
VENV_NAME=venv         # Name of your virtualen#!/bin/bash
# Simple init script for Python on DTU HPC
# Patrick M. Jensen, patmjen@dtu.dk, 2022
# Modified by August Leander Hoeg, s173944@dtu.dk, 2023.
...
#BSUB -q p1
#BSUB -J August_XtremeCT_retest_4
...
python -u test_simpleV3.py --experiment_id "ArSSR_ps32_4x_ID008004_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "EDDSR_ps32_2x_ID002004_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "MFER_ps32_2x_ID003012_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "mDCSRN_ps32_2x_ID004003_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "RRDBNet3D_ps32_2x_ID005053_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "SuperFormer_ps32_2x_ID006004_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "AugustNet_ps32_2x_ID007053_L1_100K" --cluster "DTU_HPC"


python -u test_simpleV3.py --experiment_id "AugustNet_ps32_2x_ID007093_L1_100K" --cluster "DTU_HPC"
