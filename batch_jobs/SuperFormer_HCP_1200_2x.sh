...
python -u train.py --options_file train_SuperFormer_HCP_1200_2x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_SuperFormer_HCP_1200_2x.json --cluster "DTU_HPC"
