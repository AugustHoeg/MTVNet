...
#BSUB -q p1
#BSUB -J August_XtremeCT_single_ArSSR
...
python -u train.py --options_file train_ArSSR_BRATS2023_2x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_ArSSR_BRATS2023_2x.json --cluster "DTU_HPC"

python -u train.py --options_file train_ArSSR_BRATS2023_4x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_ArSSR_BRATS2023_4x.json --cluster "DTU_HPC"
