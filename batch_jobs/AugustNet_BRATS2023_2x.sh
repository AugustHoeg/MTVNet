...
python -u train.py --options_file train_AugustNet_BRATS2023_2x.json --cluster "DTU_HPC"

python -u test_simpleV3.py --options_file train_AugustNet_BRATS2023_2x.json --cluster "DTU_HPC"
