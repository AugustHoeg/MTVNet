...
python -u train.py --options_file train_RRDBNet3D_IXI.json --cluster "DTU_HCP" 

python -u test_simpleV3.py --options_file train_RRDBNet3D_IXI.json --cluster "DTU_HPC"
